 ...
 */
function prefix(word, target, previousAttempt) {
    var re;
    var reString = '';
    var attempt = '';
    var matchPrefixes = [];
    ...
    var tmp = Array.from(target.matchAll(re));
 ...
 */
function suffix(word, target, previousAttempt) {
    var re;
    var reString = '';
    var attempt = '';
    var matchSuffixes = [];
 ...
 */
function lenite(word, attempt) {
    var _a = word.data, Navi = _a.Navi, Lenition = _a.Affixes.Lenition;
    ...
    for (var _i = 0, _b = Object.entries(getLenitionTable()); _i < _b.length; _i++) {
 ...
 */
function reconstruct(word, target) {
    var attempt = word.data.Navi;
...
var affixes = /*#__PURE__*/Object.freeze({
  __proto__: null,
  getLenitionTable: getLenitionTable,
  prefix: prefix,
  suffix: suffix,
  infix: infix,
  lenite: lenite,
...
function getWords() {
    if (dictionary.length === 0) {
        dictionary = words.map(function (w) { return new Word(w); });
    }
    return dictionary;
}
/**
...
var Word = /** @class */ (function () {
    ...
    Word.prototype.similarity = function (other) {
         ...
         */
        var similarity = (intersectionRatio + lengthRatio) / 2;
        return similarity;
    };
    /**
     * try to add prefixes to the word. Return the attempt with placed prefixes
     ...
     * @return {string} a new attempt at matching target, having added any applicable prefixes
     */
    Word.prototype.prefix = function (target, attempt) {
        return prefix(this, target, attempt);
    };
    /**
     * try to add suffixes to the word. Return the attempt with placed suffixes
     * Has to be provided with a previousAttempt, the word to go from and add suffixes to.
     ...
     * @return {string} a new attempt at matching target, having added any applicable suffixes
     */
    Word.prototype.suffix = function (target, previousAttempt) {
        return suffix(this, target, previousAttempt);
    };
    /**
     * try to add infixes to the word.
     *
     ...
     * @returns {string} the attempt with placed infixes
     */
    Word.prototype.infix = function (target) {
        return infix(this, target);
    };
    /**
     * Lenite the word, based on the attempt. The target is not relevant here, so not given.
     * Returns the lenite attempt.
     ...
     * @return {string} The lenited version of this word
     */
    Word.prototype.lenite = function (attempt) {
        return lenite(this, attempt);
    };
    /**
     * Reconstruct is the main function of affixes.go, responsible for the affixing algorithm
     * This will try to reconstruct a Word, so it matches with the target.
...
export { affixes, fwew, list$1 as list, numbers, random$1 as random, util, word };
